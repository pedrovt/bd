...
namespace Contacts
{
	public partial class Form1 : Form
	{
		...
		private void SubmitContact(Contact C)
		{
			...
			cmd.CommandText = "INSERT Customers (CustomerID, CompanyName, ContactName, Address, Phone, Fax, City, Region, PostalCode, Country) " + "VALUES (@CustomerID, @CompanyName, @ContactName, @Address, @Phone, @Fax, @City, @Region, @PostalCode, @Country) ";
